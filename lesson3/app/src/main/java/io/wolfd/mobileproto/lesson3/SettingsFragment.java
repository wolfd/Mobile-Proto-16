...
public class SettingsFragment extends Fragment {
    // What does Nullable do? I actually don't know.
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // basic settings here.
        // Probably could done something sleek with a helper function to avoid 3 copy pasted blocks
        // where all you chanced is color.
